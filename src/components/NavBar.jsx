        ...
        <div>
            <div className="navbar bg-blue-200 ">
                <div className="navbar-start lg:w-96">
                    ...
                    <h1 className="btn btn-ghost md:text-2xl -ml-7 lg:-ml-3 text-white text-sm"> <TfiCup /> Innovate <span className="-ml-2 text-orange-500">Contest</span> </h1>
                </div>
                ...
                <div className="navbar-end">
                    <div className="">
                        <label onChange={handelToggle} className="swap swap-rotate">
